...
import ru.alexbox.repository.api.BaseInterceptor
import ru.alexbox.repository.api.IApiService

class RetrofitImplementation : IDataSource<List<SearchResultDto>> {
